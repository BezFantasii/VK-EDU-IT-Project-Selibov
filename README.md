...
|---|------|-----|-------------|---------|---------|-----------|
| 1 | **Scope Creep («Синдром кухонной раковины»)** | Внутренний | Высокая | Высокое | Критический | Предотвратить |
| 2 | **Низкая конверсия / отсутствие спроса** | Внешний | Средняя | Высокое | Высокий | Смягчить |
| 3 | **Недостаточная квалификация команды** | Внутренний | Средняя | Среднее | Средний | Смягчить |
| 4 | **Регуляторные риски и возвраты** | Внешний | Низкая | Высокое | Средний | Передать / Предотвратить |
| 5 | **Превышение бюджета на инфраструктуру** | Внутренний | Средняя | Низкое | Низкий | Принять |
| 6 | **Срыв сроков разработки (Deadline risk)** | Внутренний | Средняя | Среднее | Средний | Смягчить |
